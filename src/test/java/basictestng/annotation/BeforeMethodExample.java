...
public class BeforeMethodExample {
    ...
    public void BeforeSuiteExample(){
        System.out.println("This is Before Suite of Before Method");}
    @BeforeTest
    public void BeforeTestExample(){System.out.println("This Is Before Test of Before Method");}
    @BeforeClass//this will be executed before first @test method execution.
    public void BeforeClassExample(){
        System.out.println("Before Class Example of Before Method");
    }
    ...
    public void AfterClassExample(){
        System.out.println("After Class Example of Before method");
    }
    @AfterTest
    public void AfterTestExample(){System.out.println("This Is After Test of Before Method");}
   @AfterSuite
   public void AfterSuiteExample() {System.out.println("This Is After Suite Of Before Method");}
   }
